...
func _unhandled_input(event):
	if (active):
		if (event.is_action_pressed(charArray[0][0])): GetInput(charArray[2][0],"")
		if (event.is_action_pressed(charArray[0][1])): GetInput(charArray[2][1],"")
		if (event.is_action_pressed(charArray[0][2])): GetInput(charArray[2][2],"")
		if (event.is_action_pressed(charArray[0][3])): GetInput(charArray[2][3],"")
		if (event.is_action_pressed(charArray[0][4])): GetInput(charArray[2][4],"")
		if (event.is_action_pressed(charArray[0][5])): GetInput(charArray[2][5],"")
		if (event.is_action_pressed(charArray[0][6])): GetInput(charArray[2][6],"")
		if (event.is_action_pressed(charArray[0][7])): GetInput(charArray[2][7],"")
		if (event.is_action_pressed(charArray[0][8])): GetInput(charArray[2][8],"")
		if (event.is_action_pressed(charArray[0][9])): GetInput(charArray[2][9],"")
		if (event.is_action_pressed(charArray[0][10])): GetInput(charArray[2][10],"")
		if (event.is_action_pressed(charArray[0][11])): GetInput(charArray[2][11],"")
		if (event.is_action_pressed(charArray[0][12])): GetInput(charArray[2][12],"")
		if (event.is_action_pressed(charArray[0][13])): GetInput(charArray[2][13],"")
		if (event.is_action_pressed(charArray[0][14])): GetInput(charArray[2][14],"")
		if (event.is_action_pressed(charArray[0][15])): GetInput(charArray[2][15],"")
		if (event.is_action_pressed(charArray[0][16])): GetInput(charArray[2][16],"")
		if (event.is_action_pressed(charArray[0][17])): GetInput(charArray[2][17],"")
		if (event.is_action_pressed(charArray[0][18])): GetInput(charArray[2][18],"")
		if (event.is_action_pressed(charArray[0][19])): GetInput(charArray[2][19],"")
		if (event.is_action_pressed(charArray[0][20])): GetInput(charArray[2][20],"")
		if (event.is_action_pressed(charArray[0][21])): GetInput(charArray[2][21],"")
		if (event.is_action_pressed(charArray[0][22])): GetInput(charArray[2][22],"")
		if (event.is_action_pressed(charArray[0][23])): GetInput(charArray[2][23],"")
		if (event.is_action_pressed(charArray[0][24])): GetInput(charArray[2][24],"")
		if (event.is_action_pressed(charArray[0][25])): GetInput(charArray[2][25],"")
		if (event.is_action_pressed(charArray[0][26])): GetInput("",charArray[2][26])
		if (event.is_action_pressed(charArray[0][27])): GetInput("",charArray[2][27])
